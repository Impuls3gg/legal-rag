...
class HFLLM:
    def __init__(self, model_name: str | None = None, device: str | None = None):
        ...
        # bf16 вдвое экономит память относительно fp32; на CPU считается медленнее,
        # но fp32 для 1.5B — это уже 6 ГБ, для 3B — 12 ГБ.
        self.model = (
            AutoModelForCausalLM.from_pretrained(self.model_name, dtype=torch.bfloat16)
            .to(self.device)
            .eval()
        )
